...
/**
 * SetPointCommand contains the execute method for when a user sets a location for item drop party.
 */
public class SetPointCommand {
    /**
     * Sets the location for item drop parties (premium feature).
     *
